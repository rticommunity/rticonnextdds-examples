...
The first one is the top directory which is going to be checked. And the second 
one is the ndds_version which the XSD file uses. 
...
new examples with a different schema.