...
$NDDS_HOME =  $ENV{'RTI_TOOLSDRIVE'} . "/local/preship/ndds/ndds." .
                  $NDDS_VERSION;
$NDDS_HOME = "\"C:/RTI/RTI Connext DDS Pro 510/RTI/ndds.5.1.0\"";
#set NDDSHOME
...
call_compiler ($ARCH, "C#", 
        "./examples/dynamic_data_access_union_discriminator/cs");

call_compiler ($ARCH, "Java", 
        "./examples/dynamic_data_access_union_discriminator/java");
        
#dynamic data nested structs example       
call_compiler ($ARCH, "C", "./examples/dynamic_data_nested_structs/c");

call_compiler ($ARCH, "C++", "./examples/dynamic_data_nested_structs/c++");

call_compiler ($ARCH, "C#", "./examples/dynamic_data_nested_structs/cs");

call_compiler ($ARCH, "Java", "./examples/dynamic_data_nested_structs/java");

#dynamic data sequences example
call_compiler ($ARCH, "C", "./examples/dynamic_data_sequences/c");

call_compiler ($ARCH, "C++", "./examples/dynamic_data_sequences/c++");

call_compiler ($ARCH, "C#", "./examples/dynamic_data_sequences/cs");

call_compiler ($ARCH, "Java", "./examples/dynamic_data_sequences/java");
