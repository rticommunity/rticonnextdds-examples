...
choice (e.g., *{{archwindows}}*). The *RTI Connext Core Libraries and Utilities
...
overwritten : /some/path/{{idlname}}_subscriber.cs
WARN com.rti.ndds.nddsgen.emitters.FileEmitter File exists and will not be
overwritten : /some/path/{{idlname}}_publisher.cs
```
...
The project *{{idlname}}_type-dotnet4.0.vcxproj* contains the types of the
...
```
bin\<build_type>\{{idlname}}_publisher.exe  <domain_id> <samples_to_send>
bin\<build_type>\{{idlname}}_subscriber.exe <domain_id> <sleep_periods>
```
