...
static int publisher_shutdown(
    ...
    DDS_Boolean data_is_initialized,
...
static int publisher_main(int domainId, int sample_count) {
    ...
    if (participant == NULL) {
        ...
        publisher_shutdown(participant, type_support, data_is_initialized, &data);
        return -1;
    }
    ...
    type_support = DDS_DynamicDataTypeSupport_new(type_code, 
                        &props);
    if (type_support == NULL) {
    ...
    DDS_DynamicData_set_string(&data,
                        "color", 
                        DDS_DYNAMIC_DATA_MEMBER_ID_UNSPECIFIED, 
                        "BLUE");
    DDS_DynamicData_set_long(&data,
                        "x", 
                        DDS_DYNAMIC_DATA_MEMBER_ID_UNSPECIFIED, 
                        0);
    DDS_DynamicData_set_long(&data,
    ...
    for (count=0; (sample_count == 0) || (count < sample_count); ++count) {
        ...
        retcode = DDS_DynamicDataWriter_write(
            DynamicData_writer, &data, &instance_handle);
        if (retcode != DDS_RETCODE_OK) {
