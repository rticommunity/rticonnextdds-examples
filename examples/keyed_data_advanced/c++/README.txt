...
rtiddsgen -language C++ -example i86Win32VS2010 keys.idl

On UNIX systems (assuming you want to generate an example for 
i86Linux2.6gcc4.4.3) run:

rtiddsgen -language C++ -example i86Linux2.6gcc4.4.3 keys.idl

You will see messages that look like this:

File C:\local\keyed_data_advanced\c++\keys_subscriber.cxx already exists and will not be 
...
File C:\local\keyed_data_advanced\c++\keys_publisher.cxx already exists and will not be 
...
objs\<arch_name>\keys_publisher.exe   <domain_id> 18
objs\<arch_name>\keys_subscriber.exe  <domain_id> 20

UNIX systems:

./objs/<arch_name>/keys_publisher  <domain_id> 18
./objs/<arch_name>/keys_subscriber <domain_id> 20
