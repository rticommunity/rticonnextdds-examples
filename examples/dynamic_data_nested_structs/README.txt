...
In this example, we show how to access structs nested in a dynamic data object to get/set their values.

 
Example description
-------------------
In this example, we use the two Dynamic Data APIs provided by RTI Connext to access to sample members that are not one of the primitive types. 
