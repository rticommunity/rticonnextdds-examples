...
/* deadline_contentfilterPublisher.java
...
public class deadline_contentfilterPublisher {
    ...
    private deadline_contentfilterPublisher() {
        super();
    }
    ...
    private static void publisherMain(int domainId, int sampleCount) {
        ...
        Topic topic = null;
        deadline_contentfilterDataWriter writer = null;
        ...
        try {
            ...
            writer = (deadline_contentfilterDataWriter)
            ...
            writer = (deadlineDataWriter)
                publisher.create_datawriter(
                    topic, datawriter_qos,
                    listener, StatusKind.OFFERED_DEADLINE_MISSED_STATUS);
            */
            ...
            for (int count = 0; (sampleCount == 0) || (count < sampleCount); ++count) {
                ...
                System.out.print("Writing instance0, x = " + instance0.x 
                                 + ", y = " + instance0.y + "\n");
                writer.write(instance0, handle0);

                if (count < 8) {
                    System.out.print("Writing instance1, x = " + instance1.x 
                                     + ", y = " + instance1.y + "\n");
