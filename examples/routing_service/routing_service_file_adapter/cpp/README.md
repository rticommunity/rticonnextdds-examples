...
```bash
$export RTI_LD_LIBRARY_PATH=/Applications/rti_connext_dds-6.1.1/lib/x64Darwin16clang8.0

$export SHAPE_TOPIC="Triangle"

$/Applications/rti_connext_dds-6.1.1/bin/rtiroutingservice
-cfgFile RsFileAdapter.xml
-cfgName FileAdapterToFileAdapter

RTI Routing Service 6.1.1 executing (with name FileAdapterToFileAdapter)
