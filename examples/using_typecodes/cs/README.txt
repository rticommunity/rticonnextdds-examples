...
File C:\local\using_typecodes\cs\msg_subscriber.cs already exists and will not
...
File C:\local\using_typecodes\cs\msg_publisher.cs already exists and will not 
be replaced with updated content. If you would like to get a new file with the 
new content, either remove this file or supply -replace option.
...
bin\<build_type>-VS2010\msg_subscriber.exe <domain_id> <sleep_periods>
