...
public class msgSubscriber {
		...
		try {
            ...
            */
			...
			PublicationBuiltinTopicDataDataReader builtin_publication_datareader =
					(PublicationBuiltinTopicDataDataReader)builtin_subscriber.lookup_datareader(
	...
	private static class BuiltinPublicationListener extends DataReaderAdapter {
		...
		private static String[] zero_pad = {"00000000",
			"0000000",
			"000000",
			"00000",
			"0000",
			...
			try {
				...
				for(int i = 0; i < infoSeq.size(); ++i) {
					...
					if (data.type_code == null) {
						System.out.print("No type code received, perhaps increase type_code_max_serialized_length?\n");
						continue;
					}
