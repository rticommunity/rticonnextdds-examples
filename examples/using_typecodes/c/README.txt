...
File C:\local\using_typecodes\c\msg_subscriber.c already exists and will not be 
...
File C:\local\using_typecodes\c\msg_publisher.c already exists and will not be 
...
objs\<arch_name>\msg_publisher.exe <domain_id> <sleep_periods>

On Unix systems (including Linux) run:

./objs/<arch_name>/msg_publisher  <domain_id> <samples_to_send>
./objs/<arch_name>/msg_publisher <domain_id> <sleep_periods>

The applications accept two arguments:
In two separate command prompt windows for the publisher and subscriber, 
navigate to the objs/<arch> directory and run these commands:
