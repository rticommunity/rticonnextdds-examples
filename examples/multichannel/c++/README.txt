...
File C:\local\MultiChannel\c++\MarketData_subscriber.cxx already exists and will
...
File C:\local\MultiChannel\c++\MarketData_publisher.cxx already exists and will
 not be replaced with updated content. If you would like to get a new file with
 the new content, either remove this file or supply -replace option.
File C:\local\MultiChannel\c++\USER_QOS_PROFILES.xml already exists and will
 not be replaced with updated content. If you would like to get a new file with
 the new content, either remove this file or supply -replace option.
