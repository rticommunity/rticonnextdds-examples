...
class MarketDataListener: public DDSDataReaderListener {
public:
...
void MarketDataListener::on_data_available(DDSDataReader* reader) {
    MarketDataDataReader *MarketData_reader = NULL;
    MarketDataSeq data_seq;
    DDS_SampleInfoSeq info_seq;
    DDS_ReturnCode_t retcode;
    int i;

    MarketData_reader = MarketDataDataReader::narrow(reader);
    if (MarketData_reader == NULL) {
        printf("DataReader narrow error\n");
        return;
    }

    retcode = MarketData_reader->take(data_seq, info_seq, DDS_LENGTH_UNLIMITED,
    ...
    for (i = 0; i < data_seq.length(); ++i) {
        if (info_seq[i].valid_data) {
            MarketDataTypeSupport::print_data(&data_seq[i]);
        }
    }

    retcode = MarketData_reader->return_loan(data_seq, info_seq);
...
extern "C" int subscriber_main(int domainId, int sample_count) {
    ...
    MarketDataListener *reader_listener = NULL;
    ...
    reader_listener = new MarketDataListener();
