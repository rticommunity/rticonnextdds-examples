...
*x64Win64VS2013* run:
```
rtiddsgen -language c++03 -example x64Win64VS2013 market_data.idl
```

You will see messages that look like:
```
WARN com.rti.ndds.nddsgen.emitters.FileEmitter File exists and will not be
overwritten : /some/path/market_data_subscriber.cxx
WARN com.rti.ndds.nddsgen.emitters.FileEmitter File exists and will not be
overwritten : /some/path/market_data_publisher.cxx
```
...
objs/<arch_name>/market_data_publisher.exe  <domain_id> <samples_to_send>
objs/<arch_name>/market_data_subscriber.exe <domain_id> <sleep_periods>
```
