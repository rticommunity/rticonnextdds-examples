...
public class MarketDataSubscriber {
    ...
    private static void subscriberMain(int domainId, int sampleCount) {
        ...
        MarketDataDataReader reader = null;
        ...
        try {
            ...
            reader = (MarketDataDataReader) subscriber.create_datareader(
            ...
            System.out.println("filter is Symbol MATCH 'A'");
            ...
            for (int count = 0; (sampleCount == 0) || (count < sampleCount);
                    ++count) {
                /*
                 * System.out.println("MarketData subscriber sleeping for " +
             ...
             * code for clean destruction of the participant factory singleton.
             */
    ...
    private static class MarketDataListener extends DataReaderAdapter {

        MarketDataSeq _dataSeq = new MarketDataSeq();
        SampleInfoSeq _infoSeq = new SampleInfoSeq();

        public void on_data_available(DataReader reader) {
            MarketDataDataReader MarketDataReader =(MarketDataDataReader)reader;

            try {
                MarketDataReader.take(_dataSeq, _infoSeq,
                ...
                for (int i = 0; i < _dataSeq.size(); ++i) {
                    ...
                    if (info.valid_data) {
                        System.out.println(((MarketData) _dataSeq.get(i))
                                .toString("Received", 0));
                ...
                MarketDataReader.return_loan(_dataSeq, _infoSeq);
            }
        }
    }
}
