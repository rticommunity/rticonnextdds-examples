/* MarketDataPublisher.java
 ...
 java MarketDataSubscriber <domain_id> <sample_count>

 (3) Start the publication on the same domain used for RTI Data Distribution
 Service with the command
 java MarketDataPublisher <domain_id> <sample_count>
 ...
 java -Djava.ext.dirs=$NDDSHOME/class MarketDataPublisher <domain_id>

 java -Djava.ext.dirs=$NDDSHOME/class MarketDataSubscriber <domain_id>        
...
public class MarketDataPublisher {
    ...
    private static void publisherMain(int domainId, int sampleCount) {
        ...
        Topic topic = null;
        MarketDataDataWriter writer = null;
        ...
        try {
            ...
            String typeName = MarketDataTypeSupport.get_type_name();
            MarketDataTypeSupport.register_type(participant, typeName);
            ...
            topic = participant.create_topic("Example MarketData", typeName,
             ...
             */
            writer = (MarketDataDataWriter) publisher.create_datawriter(topic, 
            ...
            MarketData instance = new MarketData();
            ...
            for (int count = 0; (sampleCount == 0) || (count < sampleCount);
                    ++count) {
                // System.out.println("Writing MarketData, count " + count);
            ...
            System.out.println("Unable to InetAddress.getByName");
        } finally {
            ...
            /*
             * RTI Data Distribution Service provides finalize_instance() method
             * for people who want to release memory used by the participant
             * factory singleton. Uncomment the following block of code for
             * clean destruction of the participant factory singleton.
             */
