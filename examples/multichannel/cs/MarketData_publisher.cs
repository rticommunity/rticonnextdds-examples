...
public class MarketDataPublisher {
    ...
    static void publish( int domain_id, int sample_count ) {
        ...
        */
        ...
        MarketDataDataWriter MarketData_writer =
            (MarketDataDataWriter)writer;
        ...
        MarketData instance = MarketDataTypeSupport.create_data();
        if (instance == null) {
            shutdown(participant);
            throw new ApplicationException(
                "MarketDataTypeSupport.create_data error");
        }
        ...
        */
        ...
        for (int count = 0;
             ...
             ++count) {
            /* Console.WriteLine("Writing MarketData, count {0}", count); */
            ...
            try {
                MarketData_writer.write(instance, ref instance_handle);
            } catch (DDS.Exception e) {
        ...
        /*
        try {
            MarketData_writer.unregister_instance(
        ...
        */
        ...
        /* Delete data sample */
        try {
            MarketDataTypeSupport.delete_data(instance);
        } catch (DDS.Exception e) {
            Console.WriteLine(
                "MarketDataTypeSupport.delete_data error: {0}", e);
        }
