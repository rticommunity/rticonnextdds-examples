...
public class asyncPublisher {
    ...
    private static void publisherMain(int domainId, int sampleCount) {
        ...
        try {
             ...
             * mode,  which enables asynchronous publishing.  We also set the 
             * flow controller to be the fixed rate flow controller, and we 
          ...
          /* The publisher have to sleep while the publisher get
           * the last sample
           */
            try {
