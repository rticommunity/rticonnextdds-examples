...
public class asyncSubscriber {
    ...
    private static void subscriberMain(int domainId, int sampleCount) {
        ...
        try {
            ...
            for (int count = 0;
                 ...
                 ++count) {
                System.out.println("async susbcriber sleeping for " + receivePeriodSec + " sec");
                try {
    ...
    private static class asyncListener extends DataReaderAdapter {
        ...
        public void on_data_available(DataReader reader) {
            asyncDataReader asyncReader =
                (asyncDataReader)reader;
