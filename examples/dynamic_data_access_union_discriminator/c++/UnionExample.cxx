...
DDS_TypeCode *createTypeCode() {
    ...
    if (err != DDS_NO_EXCEPTION_CODE) {
        cerr << "! Unable to create typecode: " << err 
              << endl;
        goto fail;
    }
    ...
    unionTC->add_member(
            ...
            err);
    if (err != DDS_NO_EXCEPTION_CODE) {
        cerr << "! Unable to add member aShort: " << err 
            << endl;
    goto fail;
    }
    ...
    unionTC->add_member(
            ...
            err);
    if (err != DDS_NO_EXCEPTION_CODE) {
        cerr << "! Unable to add member aLong: " << err 
            << endl;
        goto fail;
    }
    ...
    unionTC->add_member(
            ...
            err);
    if (err != DDS_NO_EXCEPTION_CODE) {
        cerr << "! Unable to add member aDouble: " << err 
              << endl;
        goto fail;
    }
