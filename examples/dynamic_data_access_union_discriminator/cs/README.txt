...
Modify the next file names:
    Foo-csharp.sln -> dynamic_data_union.sln
    Foo_publisher-csharp.csproj -> dynamic_data_union.csproj

Modify (in text format) dynamic_data_union.sln and change
    Foo_publisher-csharp.csproj -> dynamic_data_union.csproj     
Modify (in text format) dynamic_data_union.csproj and change 
these lines:
    <ItemGroup>
