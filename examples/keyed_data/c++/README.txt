...
File C:\local\keyed_Data\c++\keys_subscriber.cxx already exists and will not be 
...
File C:\local\keyed_Data\c++\keys_publisher.cxx already exists and will not be 
...
objs\<arch_name>\keys_publisher.exe   <domain_id> 16
objs\<arch_name>\keys_subscriber.exe  <domain_id> 18

UNIX systems:

./objs/<arch_name>/keys_publisher  <domain_id> 16
./objs/<arch_name>/keys_subscriber <domain_id> 18
