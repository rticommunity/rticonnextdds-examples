...
File C:\local\coherent_presentation\cs\coherent_subscriber.cs already exists
...
File C:\local\coherent_presentation\cs\coherent_publisher.cs already exists 
and will not be replaced with updated content. If you would like to get a new 
file with the new content, either remove this file or supply -replace option.
File C:\local\coherent_presentation\cs\USER_QOS_PROFILES.xml already exists and 
...
coherent_type-dotnet4.0.sln and build the solution. Once you've done that, open
coherent_example-csharp.sln and build the C# example.
...
bin\<build_type>-VS2010\coherent_publisher.exe  <domain_id> <samples_to_send>
bin\<build_type>-VS2010\coherent_subscriber.exe <domain_id> <sleep_periods>
