    ...
    void *listener_data, DDS_Subscriber* subscriber)
{
	...
	/* IMPORTANT for GROUP access scope: Invoking DDS_Subscriber_begin_access() */
	...
	retcode = DDS_Subscriber_get_datareaders(subscriber,&MyDataReaders,DDS_ANY_SAMPLE_STATE,
	DDS_ANY_VIEW_STATE,DDS_ANY_INSTANCE_STATE);
	if (retcode != DDS_RETCODE_OK) {
        printf("ERROR error %d\n", retcode);
		/* IMPORTANT. Remember to invoke DDS_Subscriber_end_access() before a return call. 
	...
	for(i=0; i<DDS_DataReaderSeq_get_length(&MyDataReaders); i++){
		...
		ordered_group_reader = ordered_groupDataReader_narrow(DDS_DataReaderSeq_get(&MyDataReaders,i));
		...
		retcode = ordered_groupDataReader_take_next_sample(ordered_group_reader,&data, &info); 
...
static int subscriber_main(int domainId, int sample_count)
{
    ...
    subscriber = DDS_DomainParticipant_create_subscriber(
        participant, &DDS_SUBSCRIBER_QOS_DEFAULT, &subscriber_listener /* listener */,
