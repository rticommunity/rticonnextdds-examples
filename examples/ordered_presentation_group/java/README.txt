...
rtiddsgen -language Java -example i86Win32VS2010 ordered_group.idl

On UNIX systems (assuming you want to generate an example for 
i86Linux2.6gcc4.4.5) run:

rtiddsgen -language Java -example i86Linux2.6gcc4.4.5 ordered_group.idl

You will see messages that look like this:

WARN com.rti.ndds.nddsgen.emitters.FileEmitter File exists and will not be
overwritten : 
    C:\local\ordered_presentation_group\java\ordered_groupPublisher.java
WARN com.rti.ndds.nddsgen.emitters.FileEmitter File exists and will not be 
overwritten : 
    C:\local\ordered_presentation_group\java\ordered_groupSubscriber.java
WARN com.rti.ndds.nddsgen.emitters.FileEmitter File exists and will not be 
overwritten : C:\local\ordered_presentation_group\java\USER_QOS_PROFILES.xml
