...
*x64Win64VS2013* run:
```
rtiddsgen -language java -example x64Win64VS2013 poll.idl
```

You will see messages that look like:
```
WARN com.rti.ndds.nddsgen.emitters.FileEmitter File exists and will not be
overwritten : /some/path/pollSubscriber.java
WARN com.rti.ndds.nddsgen.emitters.FileEmitter File exists and will not be
overwritten : /some/path/pollPublisher.java
```
...
make -f makefile_poll_x64Linux3gcc4.8.2
...
make ARGS="<domain_id> <samples_to_send>" -f makefile_poll_x64Linux3gcc4.8.2 pollPublisher
make ARGS="<domain_id> <sleep_periods>" -f makefile_poll_x64Linux3gcc4.8.2 pollSubscriber
