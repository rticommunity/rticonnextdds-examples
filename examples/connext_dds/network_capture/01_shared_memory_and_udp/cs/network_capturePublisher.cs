...
/// <summary>
/// Example application that publishes NetworkCaptureData
/// </summary>
public sealed class NetworkCaptureDataPublisher : INetworkCaptureDataApplication
{
    private readonly DomainParticipant participant;
    private readonly DataWriter<NetworkCaptureData> writer;

    private bool continueRunning = true;

    /// <summary>
    /// Creates a DomainParticipant, Topic, Publisher and DataWriter<NetworkCaptureData>.
    /// </summary>
    public NetworkCaptureDataPublisher(int domainId)
    {
        ...
        DataWriterQos writerQos = QosProvider.Default.GetDataWriterQos("network_capture_Library::network_capture_Profile");
    ...
    public void Run(int sampleCount)
    {
        ...
        var sample = new NetworkCaptureData();
