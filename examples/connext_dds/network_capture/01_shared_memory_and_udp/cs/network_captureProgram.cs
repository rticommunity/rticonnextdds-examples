...
/// <summary>
/// Interface shared by NetworkCaptureDataPublisher and NetworkCaptureDataSubscriber.
/// </summary>
public interface INetworkCaptureDataApplication : IDisposable
{
    /// <summary>
...
/// <summary>
/// Runs NetworkCaptureDataPublisher or NetworkCaptureDataSubscriber.
/// </summary>
public static class NetworkCaptureDataProgram
{
    /// <summary>
    ...
    public static void Main(string[] args)
    {
        ...
        INetworkCaptureDataApplication application;
        if (arguments.Pub)
        {
            Console.WriteLine($"Running NetworkCaptureDataPublisher on domain {arguments.Domain}");
            application = new NetworkCaptureDataPublisher(arguments.Domain);
        }
        else
        {
            Console.WriteLine($"Running NetworkCaptureDataSubscriber on domain {arguments.Domain}");
            application = new NetworkCaptureDataSubscriber(arguments.Domain);
        }
