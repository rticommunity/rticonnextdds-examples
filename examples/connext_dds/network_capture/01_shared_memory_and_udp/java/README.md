...
```sh
java -cp build/libs/java.jar NetworkCapturePublisher <domain_id> <samples_to_send>
java -cp build/libs/java.jar NetworkCaptureSubscriber <domain_id> <sleep_periods>
```
