...
void run_subscriber_application(unsigned int domain_id, unsigned int sample_count)
{
    ...
    dds::topic::Topic<NetworkCapture> topic(participant, "Example NetworkCapture");
    ...
    while (!application::shutdown_requested && samples_read < (sample_count-1)) {
        std::cout << "NetworkCapture subscriber sleeping up to 1 sec..." << std::endl;
