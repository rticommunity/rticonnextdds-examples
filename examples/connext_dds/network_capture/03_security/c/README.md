...
```sh
example2_publisher.exe  <domain_id> <samples_to_send>
example2_subscriber.exe <domain_id>  <samples_to_send>
```

UNIX systems:

```sh
./example2_publisher  <domain_id> <samples_to_send>
./example2_subscriber <domain_id> <samples_to_send>
```
