...
static int publisher_main(int domainId, int sample_count)
{
    ...
    inconsistent_topic = DDS_DomainParticipant_create_topic(
            participant,
            "Example listeners",
            inconsistent_topic_type_name,
     ...
     */
    inconsistent_topic_writer = DDS_Publisher_create_datawriter(
            publisher,
            inconsistent_topic,
    ...
    retcode =
            DDS_DomainParticipant_delete_topic(participant, inconsistent_topic);
    if (retcode != DDS_RETCODE_OK) {
