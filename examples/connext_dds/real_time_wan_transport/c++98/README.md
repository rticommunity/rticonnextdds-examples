...
```sh
real_time_wan_transport_publisher.exe  -d <domain_id> -s <samples_to_send> -c <scenario>
real_time_wan_transport_subscriber.exe -d <domain_id> -s <samples_to_receive> -c <scenario>
```

UNIX systems:

```sh
./real_time_wan_transport_publisher  -d <domain_id> -s <samples_to_send> -c <scenario>
./real_time_wan_transport_subscriber -d <domain_id> -s <samples_to_receive> -c <scenario>
```
...
3.  Which scenario to use (read the README.md of the parent directory for more)
