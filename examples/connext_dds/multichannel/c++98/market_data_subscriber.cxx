...
unsigned int process_data(market_dataDataReader *typed_reader)
{
        ...
        unsigned int sample_count)
{
    ...
    DDSContentFilteredTopic *filtered_topic =
    ...
    // This DataReader reads data on "Example market_data" Topic
    ...
    market_dataDataReader *typed_reader =
            market_dataDataReader::narrow(untyped_reader);
    ...
    std::cout << "filter is Symbol MATCH 'A'\n";

    bool changed_filter1 = false;
    bool changed_filter2 = false;
    ...
    while (!shutdown_requested && samples_read < sample_count) {
        ...
        if (samples_read == 3 && !changed_filter1) {
            ...
            std::cout << "changed filter to Symbol MATCH 'A,D'\n";
            changed_filter1 = true;
        }

        if (samples_read == 6 && !changed_filter2) {
            ...
            std::cout << "changed filter to Symbol MATCH 'D'\n";
