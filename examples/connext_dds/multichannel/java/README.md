...
```sh
java -cp build/libs/java.jar:$NDDSHOME/lib/java/nddsjava.jar market_dataPublisher <domain_id> <samples_to_send>
java -cp build/libs/java.jar:$NDDSHOME/lib/java/nddsjava.jar market_dataSubscriber <domain_id> <sleep_periods>
```
