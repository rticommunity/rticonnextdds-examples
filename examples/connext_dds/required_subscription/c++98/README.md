...
```sh
req_subscription_publisher.exe  -d <domain_id> -s <samples_to_send> -v <verbosity>
req_subscription_subscriber.exe -d <domain_id> -s <sleep_periods> -v <verbosity>
```

On *UNIX* systems run:

```sh
./req_subscription_publisher -d <domain_id>  -s <samples_to_send> -v <verbosity>
./req_subscription_subscriber -d <domain_id>  -s <sleep_periods> -v <verbosity>
```
