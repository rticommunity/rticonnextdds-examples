...
unsigned int process_data(hpfDataReader *typed_reader)
{
    hpfSeq data_seq;
        ...
        unsigned int sample_count)
{
    ...
    // This DataReader reads data on "Example hpf" Topic
    ...
    hpfDataReader *typed_reader = hpfDataReader::narrow(untyped_reader);
