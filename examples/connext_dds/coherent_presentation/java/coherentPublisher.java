...
public class coherentPublisher {
    ...
    private static void publisherMain(int domainId, int sampleCount) {
        ...
        Topic topic = null;
        coherentDataWriter writer = null;
...
*/            // End changes for coherent_presentation
            ...
            coherent instance = new coherent();
            instance.id = 0;
            ...
            for (int count = 0;
                ...
                instance.field = (char)((int)'a' + mod);
                instance.value = rand.nextInt(10);

                System.out.print("  Updating instance, " + instance.field +
                                 "->" + instance.value + "\n");
