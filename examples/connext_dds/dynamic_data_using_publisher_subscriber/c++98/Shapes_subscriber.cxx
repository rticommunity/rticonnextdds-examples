...
unsigned int process_data(DDSDynamicDataReader *typed_reader)
{
    /* We need to create  a DynamicDataSeq to store there the available
        ...
        unsigned int sample_count)
{
    ...
    DDSDynamicDataReader *typed_reader =
            DDSDynamicDataReader::narrow(untyped_reader);
