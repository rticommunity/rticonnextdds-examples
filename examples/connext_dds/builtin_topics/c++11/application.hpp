...
struct ApplicationArguments {
    ...
    std::string participant_password;
    std::string reader_password;
    ...
    ApplicationArguments(
            ...
            std::string participant_password_param,
            std::string reader_password_param)
            : parse_result(parse_result_param),
              domain_id(domain_id_param),
              sample_count(sample_count_param),
              verbosity(verbosity_param),
              participant_password(participant_password_param),
              reader_password(reader_password_param)
    {
    }
};
        ...
        ApplicationKind current_application)
{
    ...
    std::string reader_password = "Reader_Auth";
