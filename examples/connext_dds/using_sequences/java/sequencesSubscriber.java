...
public class sequencesSubscriber extends Application implements AutoCloseable {
    private DomainParticipant participant = null;  // Usually one per
                                                   // application
    private sequencesDataReader reader = null;
    private final sequencesSeq dataSeq = new sequencesSeq();
