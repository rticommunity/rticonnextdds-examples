...
```sh
java -cp build/libs/java.jar:$NDDSHOME/lib/java/nddsjava.jar sequencesPublisher <domain_id> <samples_to_send>
java -cp build/libs/java.jar:$NDDSHOME/lib/java/nddsjava.jar sequencesSubscriber <domain_id> <sleep_periods>
```
