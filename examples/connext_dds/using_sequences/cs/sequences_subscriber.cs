...
public class sequencesSubscriber {
    ...
    public class sequencesListener : DDS.DataReaderListener {
        ...
        public sequencesListener() {
            data_seq = new sequencesSeq();
            info_seq = new DDS.SampleInfoSeq();
        }

        private sequencesSeq data_seq;
