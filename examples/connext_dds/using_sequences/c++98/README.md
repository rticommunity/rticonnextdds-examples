...
```sh
sequences_publisher.exe  -d <domain_id> -s <samples_to_send>
sequences_subscriber.exe -d <domain_id> -s <samples_to_receive>
```

UNIX systems:

```sh
./sequences_publisher  -d <domain_id> -s <samples_to_send>
./sequences_subscriber -d <domain_id> -s <samples_to_receive>
```
