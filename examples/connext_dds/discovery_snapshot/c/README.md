...
```sh
discovery_snapshot_publisher.exe  <domain_id> <samples_to_send>
discovery_snapshot_subscriber.exe  <domain_id> <sleep_periods>
```

On *UNIX* systems run:

```sh
./discovery_snapshot_publisher  <domain_id> <samples_to_send>
./discovery_snapshot_subscriber  <domain_id> <sleep_periods>
```
...
2.  How long the examples should run, measured in samples for the publisher and
    ...
    to run forever. In this case, the default value is 5.
