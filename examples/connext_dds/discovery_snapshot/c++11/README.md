...
```sh
discovery_snapshot_publisher.exe -d <domain_id> -s <samples_to_send>
discovery_snapshot_subscriber.exe -d <domain_id> -s <sleep_periods>
```

On *UNIX* systems run:

```sh
./discovery_snapshot_publisher -d <domain_id> -s <samples_to_send>
./discovery_snapshot_subscriber -d <domain_id> -s <sleep_periods>
```
...
2.  How long the examples should run, measured in samples. In this case,
    the default is 5.
