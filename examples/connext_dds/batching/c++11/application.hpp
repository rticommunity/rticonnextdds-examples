    ...
    inline ApplicationArguments parse_arguments(int argc, char *argv[])
    {
        ...
        while (arg_processing < argc) {
            ...
            || strcmp(argv[arg_processing], "--help") == 0) {
                ...
                break;
            }else if (strcmp(argv[arg_processing], "--turbo") == 0) {
                turbo_mode = true;
                arg_processing += 2;
            } else {
        ...
        return ApplicationArguments(parse_result, domain_id, sample_count, verbosity, turbo_mode);
    }
