...
static int subscriber_main(int domainId, int sample_count, int turbo_mode_on)
{
    ...
    reader_listener.on_sample_rejected = batch_dataListener_on_sample_rejected;
    reader_listener.on_liveliness_changed =
            batch_dataListener_on_liveliness_changed;
    reader_listener.on_sample_lost = batch_dataListener_on_sample_lost;
