...
```sh
java -cp build/libs/java.jar:$NDDSHOME/lib/java/nddsjava.jar orderedPublisher <domain_id> <samples_to_send>
java -cp build/libs/java.jar:$NDDSHOME/lib/java/nddsjava.jar orderedSubscriber <domain_id> <sleep_periods>
```
