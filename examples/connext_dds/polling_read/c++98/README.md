...
```sh
poll_publisher.exe  -d <domain_id> -s <samples_to_send>
poll_subscriber.exe -d <domain_id> -s <samples_to_receive>
```

On *UNIX* systems run:

```sh
./poll_publisher  -d <domain_id> -s <samples_to_send>
./poll_subscriber -d <domain_id> -s <samples_to_receive>
```
