    ...
    private static void publisherMain(int domainId, int sampleCount) {
        ...
        try {
            ...
            for (int count = 0;
                 ...
                 ++count) {
                System.out.println("Writing poll, count " + count);

                /* Modify the instance to be written here */
                Random random = new Random();
                instance.x = (short)(random.nextInt() % 10);
                
                System.out.println("Writing poll, count " 
                		+ count + " x = " + instance.x);
