...
```sh
java -cp build/libs/java.jar:$NDDSHOME/lib/java/nddsjava.jar pollPublisher <domain_id> <samples_to_send>
java -cp build/libs/java.jar:$NDDSHOME/lib/java/nddsjava.jar pollSubscriber <domain_id> <sleep_periods>
```
