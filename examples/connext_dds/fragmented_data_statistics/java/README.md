...
```sh
java -cp build/libs/java.jar fragmentPublisher -d <domain_id> -s <samples_to_send>
java -cp build/libs/java.jar fragmentSubscriber -d <domain_id> -s <samples_to_receive>
```
