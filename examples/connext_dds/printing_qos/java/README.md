...
```sh
java -cp build/libs/java.jar printingPublisher -d <domain_id> -s <samples_to_send>
java -cp build/libs/java.jar printingSubscriber -d <domain_id> -s <samples_to_send>
```
