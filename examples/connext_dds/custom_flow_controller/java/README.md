...
```sh
java -cp build/libs/java.jar:$NDDSHOME/lib/java/nddsjava.jar cfcPublisher <domain_id> <samples_to_send>
java -cp build/libs/java.jar:$NDDSHOME/lib/java/nddsjava.jar cfcSubscriber <domain_id> <sleep_periods>
```
