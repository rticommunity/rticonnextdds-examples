...
*i86Win32VS2010* run:
```
rtiddsgen -language C++03 -example i86Win32VS2010 ccf.idl
```

You will see messages that look like this:
```
File C:\local\custom_content_filter\c++03\ccf_subscriber.cxx already exists and
will not be replaced with updated content. If you would like to get a new file
with the new content, either remove this file or supply -replace option.
File C:\local\custom_content_filter\c++03\ccf_publisher.cxx already exists and
will not be replaced with updated content. If you would like to get a new file
with the new content, either remove this file or supply -replace option.
```
