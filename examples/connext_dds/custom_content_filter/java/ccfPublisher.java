...
public class ccfPublisher extends Application implements AutoCloseable {
    ...
    private void runApplication()
    {
        ...
        ccfDataWriter writer = (ccfDataWriter) Objects.requireNonNull(
        ...
        for (int samplesWritten = 0;
             ...
             samplesWritten++) {
            System.out.println("Writing ccf, count " + samplesWritten);
    ...
    public static void main(String[] args)
    {
        ...
        try (ccfPublisher publisherApplication = new ccfPublisher()) {
