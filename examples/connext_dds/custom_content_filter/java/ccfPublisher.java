...
public class ccfPublisher {
    ...
    private static void publisherMain(int domainId, int sampleCount) {
        ...
        try {
            ...
            writer = (ccfDataWriter) publisher.create_datawriter(topic,
            ...
            for (int count = 0; (sampleCount == 0) || (count < sampleCount);
                    ++count) {
                System.out.println("Writing ccf, count " + count);
