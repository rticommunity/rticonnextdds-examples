...
```sh
java -cp build/libs/java.jar:$NDDSHOME/lib/java/nddsjava.jar keysPublisher <domain_id> <samples_to_send>
java -cp build/libs/java.jar:$NDDSHOME/lib/java/nddsjava.jar keysSubscriber <domain_id> <sleep_periods>
```
