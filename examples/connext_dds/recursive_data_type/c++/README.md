# Example code: Using Recursive Data Type
...
```
RecursiveType_publisher.exe  <domain_id> <samples_to_send>
RecursiveType_subscriber.exe <domain_id> <sleep_periods>
```

On *UNIX* systems run:
```
./RecursiveType_publisher  <domain_id> <samples_to_send>
./RecursiveType_subscriber <domain_id> <sleep_periods>
```
