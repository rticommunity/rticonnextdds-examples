...
```sh
java -cp build/libs/java.jar:$NDDSHOME/lib/java/nddsjava.jar FlightPublisher <domain_id> <samples_to_send>
java -cp build/libs/java.jar:$NDDSHOME/lib/java/nddsjava.jar FlightSubscriber <domain_id> <sleep_periods>
```
