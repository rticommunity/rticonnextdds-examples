...
```sh
java -cp build/libs/java.jar deadline_contentfilterPublisher <domain_id> <samples_to_send>
java -cp build/libs/java.jar deadline_contentfilterSubscriber <domain_id> <sleep_periods>
```
