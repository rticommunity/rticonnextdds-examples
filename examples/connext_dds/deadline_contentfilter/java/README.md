...
```sh
java -cp build/libs/java.jar:$NDDSHOME/lib/java/nddsjava.jar deadline_contentfilterPublisher -d <domain_id> -s <samples_to_send>
java -cp build/libs/java.jar:$NDDSHOME/lib/java/nddsjava.jar deadline_contentfilterSubscriber -d <domain_id> -s <samples_to_receive>
```
