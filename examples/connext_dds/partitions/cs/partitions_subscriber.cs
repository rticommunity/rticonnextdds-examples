...
public class partitionsSubscriber
{
    ...
    public class partitionsListener : DDS.DataReaderListener
    {
        ...
        {
            partitionsDataReader partitions_reader =
                (partitionsDataReader)reader;

            try
            {
                partitions_reader.take(
                    data_seq,
                    info_seq,
            ...
            for (int i = 0; i < data_length; ++i)
            {
                if (info_seq.get_at(i).valid_data)
                {
                    ...
                    partitionsTypeSupport.print_data(data_seq.get_at(i));
                }
            }

            try
            {
                partitions_reader.return_loan(data_seq, info_seq);
            }
            catch (DDS.Exception e)
            {
        ...
        public partitionsListener()
        {
            data_seq = new partitionsSeq();
            info_seq = new DDS.SampleInfoSeq();
        }

        private partitionsSeq data_seq;
    ...
    public static void Main(string[] args)
    {
        ...
        */
        ...
        try
        {
            partitionsSubscriber.subscribe(
