...
```sh
java -cp build/libs/java.jar:$NDDSHOME/lib/java/nddsjava.jar partitionsPublisher  -d <domain_id> -s <samples_to_send>
java -cp build/libs/java.jar:$NDDSHOME/lib/java/nddsjava.jar partitionsSubscriber -d <domain_id> -s <samples_to_receive>
```

On *Windows* systems run:

```sh
java -cp "build\libs\java.jar";"%NDDSHOME%\lib\java\nddsjava.jar" partitionsPublisher  -d <domain_id> -s <samples_to_send>
java -cp "build\libs\java.jar";"%NDDSHOME%\lib\java\nddsjava.jar" partitionsSubscriber -d <domain_id> -s <samples_to_receive>
```
