...
from profiles_publisher import ProfilesExamplePublisher
from profiles_subscriber import ProfilesExampleSubscriber
...
async def main():
    ...
    applications = []
    if args.pub:
        print(f"Running ProfilesExamplePublisher on domain {args.domain}")
        applications.append(ProfilesExamplePublisher(args.domain))

    if args.sub:
        print(f"Running ProfilesExampleSubscriber on domain {args.domain}")
        applications.append(ProfilesExampleSubscriber(args.domain))
