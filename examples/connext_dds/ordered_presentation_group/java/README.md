...
```sh
java -cp build/libs/java.jar ordered_groupPublisher <domain_id> <samples_to_send>
java -cp build/libs/java.jar ordered_groupSubscriber <domain_id> <sleep_periods>
```
