...
```sh
java -cp build/libs/java.jar loggingPublisher -d <domain_id> -s <samples_to_send>
java -cp build/libs/java.jar loggingSubscriber -d <domain_id> -s <samples_to_receive>
```
