...
*/
public class loggingSubscriber extends Application implements AutoCloseable {

    private DomainParticipant participant = null; // Usually one per application
    private loggingDataReader reader = null;
    private final loggingSeq dataSeq = new loggingSeq();
    ...
    private void runApplication() {
        ...
        // This DataReader reads data on "Example logging" Topic
        reader = (loggingDataReader) Objects.requireNonNull(
    ...
    public static void main(String[] args) {
        ...
        try (loggingSubscriber subscriberApplication = new loggingSubscriber()) {
