...
```sh
java -cp build/libs/java.jar DroppedSamplesExamplePublisher -d <domain_id> -s <samples_to_send>
java -cp build/libs/java.jar DroppedSamplesExampleSubscriber -d <domain_id> -s <samples_to_receive>
```
