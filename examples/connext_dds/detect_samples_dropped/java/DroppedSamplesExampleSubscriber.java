 ...
 */
public class DroppedSamplesExampleSubscriber
    ...
    private final DroppedSamplesExampleSeq dataSeq =
            new DroppedSamplesExampleSeq();
    ...
    private void runApplication()
    {
        ...
        ContentFilteredTopic cft =
                Objects.requireNonNull(participant.create_contentfilteredtopic(
    ...
    public static void main(String[] args)
    {
        ...
        try (DroppedSamplesExampleSubscriber subscriberApplication =
                     new DroppedSamplesExampleSubscriber()) {
