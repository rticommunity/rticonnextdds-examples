...
A publication of data of type DroppedSamplesExample
...
Example publication of type DroppedSamplesExample automatically generated by
...
int publisher_main(int domainId, int sample_count)
{
    ...
    /*
    instance_handle = DroppedSamplesExampleDataWriter_register_instance(
    ...
    */
    ...
    /*
    retcode = DroppedSamplesExampleDataWriter_unregister_instance(
        DroppedSamplesExample_writer, instance, &instance_handle);
    if (retcode != DDS_RETCODE_OK) {
