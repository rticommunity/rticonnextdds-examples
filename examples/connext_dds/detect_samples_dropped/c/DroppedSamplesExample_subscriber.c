...
rtiddsgen -language C -example <arch> DroppedSamplesExample.idl

Example subscription of type DroppedSamplesExample automatically generated by
        ...
        DDS_DataReader *reader)
{
    ...
    for (i = 0; i < DroppedSamplesExampleSeq_get_length(&data_seq); ++i) {
