...
public class waitset_statuscondPublisher
    ...
    private void runApplication()
    {
        ...
        waitset_statuscondDataWriter writer =
                (waitset_statuscondDataWriter) Objects.requireNonNull(
        ...
        waitset_statuscond data = new waitset_statuscond();
        ...
        for (int samplesWritten = 0;
             ...
             samplesWritten++) {
            System.out.println(
                    "Writing waitset_statuscond, count " + samplesWritten);
    ...
    public static void main(String[] args)
    {
        ...
        try (waitset_statuscondPublisher publisherApplication =
                     new waitset_statuscondPublisher()) {
