...
public class numbersSubscriber extends Application implements AutoCloseable {
    private DomainParticipant participant = null;  // Usually one per
                                                   // application
    private numbersDataReader reader = null;
    private final numbersSeq dataSeq = new numbersSeq();
    ...
    private void runApplication()
    {
        ...
        */
        ...
        // This DataReader reads data on "Example numbers" Topic
        reader = (numbersDataReader) Objects.requireNonNull(
    ...
    public static void main(String[] args)
    {
        ...
        try (numbersSubscriber subscriberApplication =
                     new numbersSubscriber()) {
