...
```sh
numbers_publisher.exe  -d <domain_id> -s <samples_to_send>
numbers_subscriber.exe -d <domain_id> -s <samples_to_receive>
```

UNIX systems:

```sh
./numbers_publisher  -d <domain_id> -s <samples_to_send>
./numbers_subscriber -d <domain_id> -s <samples_to_receive>
```
