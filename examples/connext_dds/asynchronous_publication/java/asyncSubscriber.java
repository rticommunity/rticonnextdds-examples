...
public class asyncSubscriber extends Application implements AutoCloseable {
    private DomainParticipant participant = null;  // Usually one per
                                                   // application
    private asyncDataReader reader = null;
    private final asyncSeq dataSeq = new asyncSeq();
    private final SampleInfoSeq infoSeq = new SampleInfoSeq();
    private final long initms = System.currentTimeMillis();
    ...
    private void runApplication()
    {
        ...
        reader = (asyncDataReader) Objects.requireNonNull(
    ...
    public static void main(String[] args)
    {
        ...
        try (asyncSubscriber subscriberApplication = new asyncSubscriber()) {
