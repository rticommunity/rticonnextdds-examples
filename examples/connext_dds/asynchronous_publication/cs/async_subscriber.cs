...
public class asyncSubscriber {
    ...
    public class asyncListener : DDS.DataReaderListener {
        ...
        public override void on_data_available(DDS.DataReader reader) {
            ...
            try {
                async_reader.return_loan(data_seq, info_seq);
            }
            catch(DDS.Exception e) {
        ...
        private asyncSeq data_seq;
        private DDS.SampleInfoSeq info_seq;
        private Timer timer = new Timer();
        System.UInt32 _intervals = 0;
    }; 
    ...
    static void subscribe(int domain_id, int sample_count) {
        ...
        for (int count=0;
             ...
             ++count) {
            Console.WriteLine(
                "async subscriber sleeping for {0} sec...",
                receive_period / 1000);
