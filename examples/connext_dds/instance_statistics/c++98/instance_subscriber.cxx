...
unsigned int process_data(instanceDataReader *typed_reader)
{
    instanceSeq data_seq;        // Sequence of received data
    ...
    for (int i = 0; i < data_seq.length(); ++i) {
        ...
        if (info_seq[i].valid_data) {
            ...
            instanceTypeSupport::print_data(&data_seq[i]);
            samples_read++;
        ...
        unsigned int sample_count)
{
    ...
    instanceDataReader *typed_reader =
            instanceDataReader::narrow(untyped_reader);
