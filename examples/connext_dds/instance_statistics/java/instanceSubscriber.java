...
*/
public class instanceSubscriber extends Application implements AutoCloseable {

    private DomainParticipant participant = null; // Usually one per application
    private instanceDataReader reader = null;
    private final instanceSeq dataSeq = new instanceSeq();
    ...
    private void runApplication() {
        ...
        // This DataReader reads data on "Example instance" Topic
        reader = (instanceDataReader) Objects.requireNonNull(
    ...
    public static void main(String[] args) {
        ...
        try (instanceSubscriber subscriberApplication = new instanceSubscriber()) {
