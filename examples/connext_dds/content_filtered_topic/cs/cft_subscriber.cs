...
public class cftSubscriber {
    ...
    public class cftListener : DDS.DataReaderListener {
        ...
        public override void on_data_available(DDS.DataReader reader) {
            ...
            for (int i = 0; i < data_length; ++i) {
                if (info_seq.get_at(i).valid_data) {
                    cftTypeSupport.print_data(data_seq.get_at(i));
                }
            }

            try {
                cft_reader.return_loan(data_seq, info_seq);
            }
            catch(DDS.Exception e) {
    ...
    public static void Main(string[] args) {
        ...
        */
        ...
        // --- Run --- //
        try {
            cftSubscriber.subscribe(
                domain_id, sample_count, sel_cft);
        }
        catch(DDS.Exception) {
