...
This example show how to create a "`hello world`" application written in C and
how to build it using [CMake](https://cmake.org/).

The CMakeList.txt file is self documented to allow you to understand how the
publisher and subscriber build is performed.
...
After building the example, two applications will be generated in the binary
directory, to run them, you can run the following commands:
