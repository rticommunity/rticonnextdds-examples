...
```sh
java -cp build/libs/java.jar:$NDDSHOME/lib/java/nddsjava.jar tbfPublisher <domain_id> <samples_to_send>
java -cp build/libs/java.jar:$NDDSHOME/lib/java/nddsjava.jar tbfSubscriber <domain_id> <sleep_periods>
```
