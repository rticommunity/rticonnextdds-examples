...
public class sequencesSubscriber {
    // -----------------------------------------------------------------------
    // Public Methods
    // -----------------------------------------------------------------------
    ...
    private static void subscriberMain(int domainId, int sampleCount) {
        ...
        sequencesDataReader reader = null;
        ...
        try {
            ...
            listener = new sequencesListener();
    
            /* To customize data reader QoS, use
               the configuration file USER_QOS_PROFILES.xml */
    
            reader = (sequencesDataReader)
            ...
            for (int count = 0;
                 ...
                 ++count) {
                System.out.println("sequences subscriber sleeping for "
    ...
    private static class sequencesListener extends DataReaderAdapter {
            
        sequencesSeq _dataSeq = new sequencesSeq();
        SampleInfoSeq _infoSeq = new SampleInfoSeq();

        public void on_data_available(DataReader reader) {
            sequencesDataReader sequencesReader =
                (sequencesDataReader)reader;
            
            try {
                sequencesReader.take(
                    _dataSeq, _infoSeq,
                ...
                for(int i = 0; i < _dataSeq.size(); ++i) {
                    ...
                    if (info.valid_data) {
                        System.out.println(
                            ((sequences)_dataSeq.get(i)).toString("Received",0));
                ...
                sequencesReader.return_loan(_dataSeq, _infoSeq);
            }
        }
    }
}
