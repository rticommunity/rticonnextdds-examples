...
File C:\local\time_based_filter\cs\tbf_subscriber.cs already exists and will 
...
File C:\local\time_based_filter\cs\tbf_publisher.cs already exists and will 
not be replaced with updated content. If you would like to get a new file with 
the new content, either remove this file or supply -replace option.
...
bin\<build_type>-VS2010\tbf_publisher.exe  <domain_id> <samples_to_send>
bin\<build_type>-VS2010\tbf_subscriber.exe <domain_id> <sleep_periods>
