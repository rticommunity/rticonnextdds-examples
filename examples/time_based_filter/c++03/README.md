...
*x64Win64VS2013* run:
```
rtiddsgen -language c++03 -example x64Win64VS2013 tbf.idl
```

You will see messages that look like:
```
WARN com.rti.ndds.nddsgen.emitters.FileEmitter File exists and will not be
overwritten : /some/path/tbf_subscriber.cxx
WARN com.rti.ndds.nddsgen.emitters.FileEmitter File exists and will not be
overwritten : /some/path/tbf_publisher.cxx
```
...
objs/<arch_name>/tbf_publisher.exe  <domain_id> <samples_to_send>
objs/<arch_name>/tbf_subscriber.exe <domain_id> <sleep_periods>
```
