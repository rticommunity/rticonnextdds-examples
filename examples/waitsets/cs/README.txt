...
File C:\local\waitsets\cs\waitsets_subscriber.cs already exists and will
...
not be replaced with updated content. If you would like to get a new file with
the new content, either remove this file or supply -replace option.
File C:\local\waitsets\cs\USER_QOS_PROFILES.xml already exists and will
not be replaced with updated content. If you would like to get a new file with
the new content, either remove this file or supply -replace option.
...
waitsets_type-dotnet4.0.sln and build the solution. Once you've done that, open
waitsets_example-csharp.sln and build the C# example.
...
bin\<build_type>-VS2010\waitsets_publisher.exe  <domain_id> <samples_to_send>
bin\<build_type>-VS2010\waitsets_subscriber.exe <domain_id> <sleep_periods>
