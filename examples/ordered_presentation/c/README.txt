...
choice (e.g., i86Win32VS2008 or i86Linux2.6gcc4.4.5). The RTI Connext DDS Core 
...
rtiddsgen -language C -example i86Win32VS2008 ordered.idl

On UNIX systems (assuming you want to generate an example for 
i86Linux2.6gcc4.4.5) run:

rtiddsgen -language C -example i86Linux2.6gcc4.4.5 ordered.idl
...
File C:\local\Ordered_Presentation\c\ordered_subscriber.c already exists and 
will not be replaced with updated content. If you would like to get a new file 
with the new content, either remove this file or supply -replace option.
File C:\local\Ordered_Presentation\c\ordered_publisher.c already exists and will
...
File C:\local\Ordered_Presentation\c\USER_QOS_PROFILES.xml already exists and 
will not be replaced with updated content. If you would like to get a new file 
with the new content, either remove this file or supply -replace option.
