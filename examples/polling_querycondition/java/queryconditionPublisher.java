...
public class queryconditionPublisher {
    // -----------------------------------------------------------------------
    // Public Methods
    // -----------------------------------------------------------------------
    ...
    private queryconditionPublisher() {
        super();
    }
    ...
    private static void publisherMain(int domainId, int sampleCount) {
        ...
        Topic topic = null;
        queryconditionDataWriter writer = null;
        ...
        try {
            ...
            writer = (queryconditionDataWriter)
            ...
            querycondition instance = new querycondition();
            ...
            for (int count = 0;
                 ...
                 ++count) {
                System.out.println("Writing querycondition, count " + count);

                /* Modify the instance to be written here */
                instance.id = "GUID" + count % 3;
