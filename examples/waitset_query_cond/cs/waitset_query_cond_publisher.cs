...
using System.Text;
/* waitset_query_cond_publisher.cs
...
public class waitset_query_condPublisher {
    ...
    public static void Main(string[] args) {
        ...
        */
        ...
        // --- Run --- //
        try {
            waitset_query_condPublisher.publish(
    ...
    static void publish(int domain_id, int sample_count) {
        ...
        waitset_query_condDataWriter waitset_query_cond_writer =
            (waitset_query_condDataWriter)writer;

        // --- Write --- //

        /* Create data sample for writing */
        waitset_query_cond instance = waitset_query_condTypeSupport.create_data();
        if (instance == null) {
            shutdown(participant);
        ...
        */
        ...
        /* Main loop */
        const System.Int32 send_period = 500; // milliseconds
        for (int count=0;
             (sample_count == 0) || (count < sample_count);
             ++count) {
            Console.WriteLine("Writing waitset_query_cond, count {0}", count);
            ...
            try {
                waitset_query_cond_writer.write(instance, ref instance_handle);
            }
            catch(DDS.Exception e) {
        ...
        /*
        try {
            waitset_query_cond_writer.unregister_instance(
        ...
        */
        ...
        /* Delete data sample */
        try {
            waitset_query_condTypeSupport.delete_data(instance);
        } catch(DDS.Exception e) {
            Console.WriteLine(
                "waitset_query_condTypeSupport.delete_data error: {0}", e);
        }
