...
public class DeviceStatusSubscriber extends Application implements AutoCloseable {
    ...
    public static void main(String[] args) {
        ...
        try (DeviceStatusSubscriber subscriberApplication = new DeviceStatusSubscriber()) {
