...
*/
public class VehicleMetricsPublisher extends Application implements AutoCloseable {
    ...
    private void runApplication() {
        ...
        VehicleMetrics data = new VehicleMetrics();
        ...
        && samplesWritten < getMaxSampleCount(); samplesWritten++) {
            ...
            System.out.println("Writing VehicleMetrics, count " + samplesWritten);
    ...
    public static void main(String[] args) {
        ...
        try (VehicleMetricsPublisher publisherApplication = new VehicleMetricsPublisher()) {
