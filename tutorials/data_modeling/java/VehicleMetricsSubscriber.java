...
*/
public class VehicleMetricsSubscriber extends Application implements AutoCloseable {

    private DomainParticipant participant = null; // Usually one per application
    private static final String TAG = "RTIConnextLog";
    private VehicleMetricsDataReader reader = null;
    private final VehicleMetricsSeq dataSeq = new VehicleMetricsSeq();
    ...
    private void runApplication() {
        ...
        String typeName = VehicleMetricsTypeSupport.get_type_name();
        VehicleMetricsTypeSupport.register_type(participant, typeName);

        // Create a Topic with a name and a datatype
        Topic topic = Objects.requireNonNull(
            participant.create_topic(
                "Example VehicleMetrics",
                typeName,
    ...
    public static void main(String[] args) {
        ...
        try (VehicleMetricsSubscriber subscriberApplication = new VehicleMetricsSubscriber()) {
